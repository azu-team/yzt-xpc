...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config = __webpack_require__(/*! ./config.js */ 16);
...
{var url = _ref.url,_ref$root = _ref.root,root = _ref$root === void 0 ? _config.http_root : _ref$root,_ref$method = _ref.method,method = _ref$method === void 0 ? 'POST' : _ref$method,header = _ref.header,_ref$params = _ref.params,params = _ref$params === void 0 ? {} : _ref$params,successCallback = _ref.successCallback,failCallback = _ref.failCallback,completeCallback = _ref.completeCallback,_ref$showLoading = _ref.showLoading,showLoading = _ref$showLoading === void 0 ? true : _ref$showLoading;
  if (showLoading) {
    uni.showLoading();
  }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.http_root = void 0; // const http_root = 'http://192.168.1.107:8015'
...
/***/ 17:
/*!****************************************************!*\
  !*** C:/Users/azu/Desktop/yzt_xcx/utils/format.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _amapWx = _interopRequireDefault(__webpack_require__(/*! ./amap-wx.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}Date.prototype.Format = function (fmt) {var o = { "M+": this.getMonth() + 1, //月份
    "d+": this.getDate(), //日
    "h+": this.getHours(), //小时
    "m+": this.getMinutes(), //分
    "s+": this.getSeconds(), //秒
  ...
  };if (/(y+)/.test(fmt)) fmt = fmt.replace(RegExp.$1, (this.getFullYear() + "").substr(4 - RegExp.$1.length));for (var k in o) {if (new RegExp("(" + k + ")").test(fmt)) fmt = fmt.replace(RegExp.$1, RegExp.$1.length == 1 ? o[k] : ("00" + o[k]).substr(("" + o[k]).length));}return fmt;};_vue.default.prototype.$tranform_code2name = function (arr, target) {if (!arr.length) return '';var result = '';arr.forEach(function (item, index) {if (item.id == target) {result = item.value;}});return result;};var amapPlugin = new _amapWx.default.AMapWX({ key: 'ce334d5499fb668332c1a65513a54201' });_vue.default.prototype.$getLocationByAmap = function () {return new Promise(function (resolve, reject) {amapPlugin.getRegeo({ success: function success(data) {
        console.log(data);
        resolve(data);
      },
...
/***/ 18:
/*!*****************************************************!*\
  !*** C:/Users/azu/Desktop/yzt_xcx/utils/amap-wx.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__6EB2942" };exports.default = _default;
